...
const exec_name = process.argv.length > 2 ? process.argv[2] : (process.env.npm_package_config_executableName ? process.env.npm_package_config_executableName : 'strapi-app');
...
zip.addLocalFolder('exec', packageName);
